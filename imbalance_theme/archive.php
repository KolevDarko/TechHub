<?php get_header(); ?> 
				  <?php /* If this is a category archive */ if (is_category()) { ?>
                    <h1><?php printf(__('Архива за постови од  &#8216;%s&#8217; '), single_cat_title('', false)); ?></h1>
                  <?php /* If this is a tag archive */ } elseif( is_tag() ) { ?>
                    <h1"><?php printf(__('Тагирани Постови &#8216;%s&#8217;'), single_tag_title('', false) ); ?></h1>
                  <?php /* If this is a daily archive */ } elseif (is_day()) { ?>
                    <h1><?php printf(_c('Архива за  %s|Дневна архива'), get_the_time(__('F jS, Y'))); ?></h1>
                  <?php /* If this is a monthly archive */ } elseif (is_month()) { ?>
                    <h1><?php printf(_c('Архива за  %s| Месечните постови'), get_the_time(__('F, Y'))); ?></h1>
			...
			if ( has_post_thumbnail() ) { ?>
                    ...
                    <div class="article-over">
                      ...
                      <div class="postmetadata">
                          ...
                          <?php printf(__('Категораија: %s'), get_the_category_list(', ')); ?>
                      </div>
                    </div>
                </li> <?php ?>
            <?php endwhile; ?>
