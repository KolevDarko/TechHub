...
<input type="text" name="author" id="author"  onfocus="if(this.value=='Name *') this.value='';" onblur="if(this.value=='') this.value='Name *';" value="Name *" tabindex="1" <?php // if ($req) echo "aria-required='true'"; ?> />
